...
由于笔者没有公众号，因此没有尝试配置公众号订阅，不知道配置好了以后是什么样子的。打赏的效果是在文章底部出现一个按钮，点击后才显示刚刚设置的二维码图片。
...
注意，attr的第二项要填你的网站图标的相对路径，不然切换之后网站的图标就没了。具体写法请参考主题配置文件的`favicon: `的设置。
...
个人最推荐使用`tsumiki`，因为“功能”最全。当然笔者也并没有一一试过，读者大可选择自己喜欢的那个。